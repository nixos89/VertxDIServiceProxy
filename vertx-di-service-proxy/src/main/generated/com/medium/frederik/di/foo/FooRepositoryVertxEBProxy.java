...
public class FooRepositoryVertxEBProxy implements FooRepository {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public FooRepositoryVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public FooRepositoryVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
